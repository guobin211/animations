...
import { SpaceShip } from "../../core/shape/SpaceShip";
import { TS_CODE } from "./code";

@Component({
  selector: "app-keyboard-action",
  templateUrl: "./keyboard-action.component.html",
  styles: [],
})
export class KeyboardActionComponent extends AutoCanvasComponent implements AfterViewInit {
  constructor() {
    super();
    this.tsCode = TS_CODE;
  }
  ...
  ngAfterViewInit(): void {
    this.useAnimateFn(spaceAnimate);
  }
}
